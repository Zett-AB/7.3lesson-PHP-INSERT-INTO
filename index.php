                ...
                <body>
                    <main>
                        ...
                        <section class="main_part">
                            ...
                            <p>
                                Оператор INSERT обычно использует с INTO(перевод - добавить в).<br>
                                Синтаксис для оператора INSERT мы указали ранее, но повторим его еще раз, но с учетом нашей БД.
                            </p>
                            <p>
                            ...
                            <p>Таким образом, для внесения новой информации в нашу таблицу
                            ...
                            <p class="code_bd">В конечном виде наш код по добавлению новой информации в нашу
                        ...
                        <section class="code_php">
                            ...
                            <p>
                                ...
                                echo $row['name'] . $row['descriptions'].$row['year'].$row['add-date']."br>";
                                }
                            </p>
                            <p>
                            ...
                            <p>
                                <b>ВАЖНО!</b>
                                Нужно помнить, что наш скрипт/код по внесению информации в БД будет срабатывать каждый раз как мы обновляем таблицу или браузер. То есть при повторном запуску скрипта/кода информация будет добавлятся из него в нашу таблицу БД снова и снова.
                            </p>
